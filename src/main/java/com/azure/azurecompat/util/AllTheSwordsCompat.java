...
public class AllTheSwordsCompat {
	...
	public AllTheSwordsCompat() {
		MineAndSlashAPI.addCompatibleItem(MODID + "dirtsword",
		...
		for (String a : BOW) {
			MineAndSlashAPI.addCompatibleItem("alltheswords:" + a, new ConfigItem().setType(new Bow()).setMinLevel(5).setdropsAsLoot(false));
		}
