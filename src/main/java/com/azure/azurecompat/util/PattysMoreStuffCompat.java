...
public class PattysMoreStuffCompat {
	...
	public PattysMoreStuffCompat() {
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "brick_sword",
				new ConfigItem().setType(Sword.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "stone_bow",
				new ConfigItem().setType(Bow.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "iron_bow",
				new ConfigItem().setType(Bow.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "gold_bow",
				new ConfigItem().setType(Bow.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "diamond_bow",
				new ConfigItem().setType(Bow.INSTANCE).setSalvagable(true));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "netherbrick_bow",
				new ConfigItem().setType(Bow.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "wooden_battle_axe",
				new ConfigItem().setType(Axe.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "iron_battle_axe",
				new ConfigItem().setType(Axe.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "gold_battle_axe",
				new ConfigItem().setType(Axe.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "diamond_battle_axe",
				new ConfigItem().setType(Axe.INSTANCE).setSalvagable(true));
		MineAndSlashAPI.addCompatibleItem(MODID + "stone_battle_axe",
				new ConfigItem().setType(Axe.INSTANCE).setSalvagable(true));
