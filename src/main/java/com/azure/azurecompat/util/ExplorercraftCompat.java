...
public class ExplorercraftCompat {
	...
	public ExplorercraftCompat() {
		MineAndSlashAPI.addCompatibleItem(MODID + "jade_sword", new ConfigItem().setType(new Sword()).setMinLevel(50).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "wizard_staff", new ConfigItem().setType(new Staff()).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "jade_chest", new ConfigItem().setType(new Chest()).setMinLevel(50).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "ruby_chest",
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "jade_boots", new ConfigItem().setType(new Boots()).setMinLevel(50).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "welsh_shield", new ConfigItem().setType(new Shield()).setdropsAsLoot(false));
	}
}