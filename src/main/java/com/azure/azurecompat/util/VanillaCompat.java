...
public class VanillaCompat {
	...
	public VanillaCompat() {
		...
		MineAndSlashAPI.addCompatibleItem("minecraft:bow", new ConfigItem().setType(Bow.INSTANCE));
		...
		MineAndSlashAPI.addCompatibleItem("minecraft:shield", new ConfigItem().setType(Shield.INSTANCE));
