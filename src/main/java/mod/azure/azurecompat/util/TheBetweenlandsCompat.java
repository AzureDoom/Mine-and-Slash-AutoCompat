...
public class TheBetweenlandsCompat {
	...
	public TheBetweenlandsCompat() {
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "shockwave_sword",
				new ConfigItem().setType(new Sword()).setMinLevel(50).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "weedwood_sword", new ConfigItem().setType(new Sword())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "bone_sword", new ConfigItem().setType(new Sword()).setMaxRarity(1)
				.setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "octine_sword", new ConfigItem().setType(new Sword()).setMaxRarity(2)
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "dentrothyst_shield_orange",
				new ConfigItem().setType(new Shield()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "dentrothyst_shield_green_polished",
				new ConfigItem().setType(new Shield()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "dentrothyst_shield_green",
				new ConfigItem().setType(new Shield()).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "weedwood_bow",
				new ConfigItem().setType(new Bow()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "predator_bow",
				new ConfigItem().setType(new Bow()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "bone_helmet", new ConfigItem().setType(new Helmet()).setMaxRarity(1)
				.setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "bone_chestplate", new ConfigItem().setType(new Chest())
				.setMaxRarity(1).setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "bone_leggings", new ConfigItem().setType(new Pants()).setMaxRarity(1)
				.setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "bone_boots", new ConfigItem().setType(new Boots()).setMaxRarity(1)
				.setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "lurker_skin_helmet", new ConfigItem().setType(new Helmet())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "lurker_skin_chestplate", new ConfigItem().setType(new Chest())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "lurker_skin_leggings", new ConfigItem().setType(new Pants())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "lurker_skin_boots", new ConfigItem().setType(new Boots())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "rubber_boots", new ConfigItem().setType(new Boots()).setMaxRarity(1)
				.setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "marsh_runner_boots", new ConfigItem().setType(new Boots())
				.setMaxRarity(1).setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "syrmorite_helmet", new ConfigItem().setType(new Helmet())
				.setMaxRarity(2).setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "syrmorite_chestplate", new ConfigItem().setType(new Chest())
				.setMaxRarity(2).setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "syrmorite_leggings", new ConfigItem().setType(new Pants())
				.setMaxRarity(2).setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "syrmorite_boots", new ConfigItem().setType(new Boots())
				.setMaxRarity(2).setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
	}
}