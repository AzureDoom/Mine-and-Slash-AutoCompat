...
public class MegaLootCompat {
	...
	public MegaLootCompat() {
		MineAndSlashAPI.addCompatibleItem("megaloot:weaponsword",
				new ConfigItem().setType(new Helmet()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:armor_helmet",
				new ConfigItem().setType(new Helmet()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:armor_chestplate",
				new ConfigItem().setType(new Chest()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:armor_leggings",
				new ConfigItem().setType(new Pants()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:armor_boots",
				new ConfigItem().setType(new Boots()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:weaponbow",
				new ConfigItem().setType(new Helmet()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem("megaloot:baublering",
				new ConfigItem().setType(new Helmet()).setdropsAsLoot(false));
	}
}