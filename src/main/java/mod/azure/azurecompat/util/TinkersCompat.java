...
public class TinkersCompat {
	...
	public TinkersCompat() {
		MineAndSlashAPI.addCompatibleItem(MODID + "shortbow",
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "crossbow",
				new ConfigItem().setType(new Bow()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "skuriken",
				new ConfigItem().setType(new Bow()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "scythe", new ConfigItem().setType(new Axe()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "cleaver",
				new ConfigItem().setType(new Hammer()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "rapier",
				new ConfigItem().setType(new Sword()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "broadsword",
				new ConfigItem().setType(new Sword()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "longsword",
				new ConfigItem().setType(new Sword()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "frypan",
				new ConfigItem().setType(new Sword()).setdropsAsLoot(false));
	}
}