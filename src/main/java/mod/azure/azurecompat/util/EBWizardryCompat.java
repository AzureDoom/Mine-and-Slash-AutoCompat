...
import mod.azure.azurecompat.AzureCompat;
	...
	public EBWizardryCompat() {
		...
		for (String s : TYPE) {
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_hat", new ConfigItem().setType(new Helmet())
					.setMaxRarity(2).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_hat_" + s, new ConfigItem().setType(new Helmet())
					.setMaxRarity(2).setAlwaysNormal().setMinLevel(30).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_robe", new ConfigItem().setType(new Chest())
					.setMaxRarity(2).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_robe_" + s, new ConfigItem().setType(new Chest())
					.setMaxRarity(2).setAlwaysNormal().setMinLevel(30).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_leggings", new ConfigItem().setType(new Pants())
					.setMaxRarity(2).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_leggings_" + s, new ConfigItem().setType(new Pants())
					.setMaxRarity(2).setAlwaysNormal().setMinLevel(30).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_boots", new ConfigItem().setType(new Boots())
					.setMaxRarity(2).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
			MineAndSlashAPI.addCompatibleItem(modID + "wizard_boots" + s, new ConfigItem().setType(new Boots())
					.setMaxRarity(2).setAlwaysNormal().setMinLevel(30).setdropsAsLoot(false));
		}
		for (String s : Ring) {
