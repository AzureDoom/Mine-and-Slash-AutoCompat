...
public class AetherLegacyCompat {
	...
	public AetherLegacyCompat() {
		MineAndSlashAPI.addCompatibleItem(MODID + "dart_shooter",
				new ConfigItem().setType(new Bow()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "cloud_staff",
				new ConfigItem().setType(new Staff()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "nature_staff",
				new ConfigItem().setType(new Staff()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "leather_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "iron_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "golden_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "chain_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "diamond_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "gravitite_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "neptune_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "phoenix_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "obsidian_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "valkyrie_gloves",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "red_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "blue_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "yellow_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "white_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "swet_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "invisibility_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "agility_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "valkyrie_cape",
				new ConfigItem().setType(new Charm()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "iron_ring",
				new ConfigItem().setType(new Ring()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "golden_ring",
				new ConfigItem().setType(new Ring()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_ring",
				new ConfigItem().setType(new Ring()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "ice_ring",
				new ConfigItem().setType(new Ring()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "iron_pendant",
				new ConfigItem().setType(new Necklace()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "golden_pendant",
				new ConfigItem().setType(new Necklace()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_pendant",
				new ConfigItem().setType(new Necklace()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "ice_pendant",
				new ConfigItem().setType(new Necklace()).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "phoenix_bow",
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "notch_hammer", new ConfigItem().setType(new Hammer()).setMaxRarity(2)
				.setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_sword", new ConfigItem().setType(new Sword()).setMaxRarity(0)
				.setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "skyroot_sword", new ConfigItem().setType(new Sword()).setMaxRarity(0)
				.setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "candy_can_sword", new ConfigItem().setType(new Sword())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "holystone_sword", new ConfigItem().setType(new Sword())
				.setMaxRarity(1).setAlwaysNormal().setMaxLevel(20).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "pig_slayer", new ConfigItem().setType(new Sword()).setMaxRarity(2)
				.setAlwaysNormal().setMaxLevel(30).setdropsAsLoot(false));
		...
		MineAndSlashAPI.addCompatibleItem(MODID + "gravitite_sword",
				new ConfigItem().setType(new Sword()).setMinLevel(50).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "holy_sword",
				new ConfigItem().setType(new Sword()).setMinLevel(50).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "vampire_sword",
				new ConfigItem().setType(new Sword()).setMinLevel(50).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_helmet", new ConfigItem().setType(new Helmet())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_chestplate", new ConfigItem().setType(new Chest())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_leggings", new ConfigItem().setType(new Pants())
				.setMaxRarity(0).setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
		MineAndSlashAPI.addCompatibleItem(MODID + "zanite_boots", new ConfigItem().setType(new Boots()).setMaxRarity(0)
				.setAlwaysNormal().setMaxLevel(10).setdropsAsLoot(false));
